...
def display_all_samples():
    ...
    choose_file_text = "Select a background sample" if variables.background_sample_path is None else "Select samples for the keyboard"
